...
class CountryState
{
    ...
    public function getCountries($language = null)
    {
        ...
        //format result to named array
        $new_countries_array = [];
        foreach ($this->countriesTranslated as $i => $k) {
          $item = [];
          $item['code'] = $i;
          $item['name'] = $k;
          $new_countries_array[] = $item;
        }
        $countries = $new_countries_array;

        return $countries;
        //end format result to named array
    ...
    public function getStates($country)
    {
        ...
        $states = $this->findCountryStates($country);

        //format result to named array
        $new_states_array = [];
        foreach ($states as $i => $k) {
          $item = [];
          $item['code'] = $i;
          $item['name'] = $k;
          $new_states_array[] = $item;
        }
