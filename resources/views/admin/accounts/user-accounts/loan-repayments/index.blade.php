...
@section('title')
    ...
    Manage User Loan Repayment Accounts
...
@section('content')
    ...
    <div class="container-fluid">
       ...
       <div class="row heading-bg">
          ...
          <!-- Breadcrumb -->
          <div class="col-sm-6 col-xs-12">
              {!! Breadcrumbs::render('user-loan-repayments-accounts') !!}
          </div>
          <!-- /Breadcrumb -->
       </div>
       <!-- /Title -->
                  ...
                  <div class="panel panel-default card-view panel-refresh">
                       ...
                       <div class="panel-heading panel-heading-dark">
                                ...
                                <div class="btn-group">
                                    <div class="dropdown">
                                       ...
                                       <ul role="menu" class="dropdown-menu">
                                          ...
                                          <li>
                                            <a href="{{ route('excel.user-loan-repayments-accounts', 
                                                        ['xls', 
                                          ...
                                          <li><a href="{{ route('excel.user-loan-repayments-accounts', 'csv') }}">As CSV</a></li>
                                          <li><a href="{{ route('excel.user-loan-repayments-accounts', 'pdf') }}">As PDF</a></li>
                          ...
                          <div class="pull-right col-sm-9">
                            ...
                            <form action="{{ route('user-loan-repayments-accounts.index') }}">
                                           ...
                                           @foreach ($accounts as $account)                                  
                                             <tr>
                                                ...
                                                <td>
                                                   ...
                                                   <a href="{{ route('user-loan-repayments-accounts.show', $account->id) }}" class="btn btn-info btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-eye"></i> 
                                                   </a>

                                                   <a href="{{ route('user-loan-repayments-accounts.edit', $account->id) }}" class="btn btn-primary btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-edit"></i> 
                                                   </a>

                                                   <a href="{{ route('user-loan-repayments-accounts.destroy', $account->id) }}" class="btn btn-danger btn-sm btn-icon-anim btn-square">
