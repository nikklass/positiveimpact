...
@section('content')
    ...
    <div class="container-fluid">
       ...
       <div class="row heading-bg">
          ...
          <!-- Breadcrumb -->
          <div class="col-sm-6 col-xs-12">
              {!! Breadcrumbs::render('yehu-deposits') !!}
          </div>
          <!-- /Breadcrumb -->
       </div>
       <!-- /Title -->
                  ...
                  <div class="panel panel-default card-view panel-refresh">
                       ...
                       <div class="panel-heading panel-heading-dark">
                                ...
                                <div class="btn-group">
                                    <div class="dropdown">
                                       ...
                                       <ul role="menu" class="dropdown-menu">
                                          ...
                                          <li>
                                            <a href="{{ route('excel.yehu-deposits', 
                                                        ['xls', 
                                          ...
                                          <li><a href="{{ route('excel.yehu-deposits', 'csv') }}">As CSV</a></li>
                                          <li><a href="{{ route('excel.yehu-deposits', 'pdf') }}">As PDF</a></li>
                          ...
                          <div class="pull-right col-sm-9">
                            ...
                            <form action="{{ route('yehu-deposits.index') }}">
                                  ...
                                  <div class="table-responsive">
                                     <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                           ...
                                           @foreach ($yehudeposits as $yehudep)                                  
                                             <tr>
                                                ...
                                                <td class="txt-dark weight-500">
                                                    {{ $yehudep->full_name }}
                                                </td>

                                                <td align="right">
                                                  <span class="weight-500 text-primary">
                                                      @if ($yehudep->amount)
                                                        {{ format_num($yehudep->amount) }}
                                                      @endif
                                                  </span>
                                                </td>
                                                ...
                                                <td>
                                                  <span class="txt-dark weight-500">
                                                    {{ $yehudep->paybill_number }}
                                                  </span>
                                                </td>

                                                <td>
                                                   <span class="txt-dark weight-500">
                                                      @if ($yehudep->processed)
                                                ...
                                                <td>
                                                   <span class="txt-dark weight-500">
                                                   {{ formatFriendlyDate($yehudep->created_at) }}
                                                   </span>
                                                </td>
                                                
                                                <td>

                                                   <a href="{{ route('yehu-deposits.show', $yehudep->id) }}" class="btn btn-info btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-eye"></i> 
                                                   </a>

                                                   @if (!$yehudep->processed)
                                                   <a href="{{ route('yehu-deposits.edit', $yehudep->id) }}" class="btn btn-primary btn-sm btn-icon-anim btn-square">
