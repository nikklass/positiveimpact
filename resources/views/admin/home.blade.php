        ...
        <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="panel panel-default card-view equalheight">
                       <div class="panel-heading">
                          <div class="pull-left">
                             <h6 class="panel-title txt-dark">Savings</h6>
                          </div>
           ...
           <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                   <div class="panel panel-default card-view panel-refresh equalheight">
                     ...
                     <div class="panel-heading">
                        <div class="pull-left">
                           <h6 class="panel-title txt-dark">Loans</h6>
                        </div>
                        <div class="pull-right">
        ...
        <div class="row">
           ...
           <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              <div class="panel panel-default card-view panel-refresh equalheight">
                 ...
                 <div class="panel-heading">
                    <div class="pull-left">
                       <h6 class="panel-title txt-dark">Company Join Requests</h6>
                    </div>
                    <div class="pull-right">
                       <a href="#" class="pull-left inline-block refresh mr-15">
                          <i class="zmdi zmdi-replay"></i>
                          ...
                          <div class="table-responsive">
                             <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                   ...
                                   @foreach ($company_join_requests as $companyJoinRequest) 
                                   <tr>
                                      ...
                                      <td>
                                         <span class="txt-dark weight-500">
                                           {{ $companyJoinRequest->created_at->toFormattedDateString() }}
                                         </span>
                                      </td>
