                              ...
                              <div class="panel-body">               
                                 ...
                                 <div class="form-wrap">
                                    ...
                                    <form class="form-horizontal" method="POST" 
                                        action="{{ route('loan-applications.update_approve', $loanapplication->id) }}"  data-parsley-validate> 
                                       ...
                                       <div  class="form-group">
                                          ...
                                          <div class="col-sm-8">
                                             ...
                                             <input class="form-control" 
                                             value="{{ $loanapplication->product->name }}" 
                                             readonly>
                                       ...
                                       <div  class="form-group">
                                          ...
                                          <label for="repayment_cycle" class="col-sm-4 control-label">
                                             Repayment Cycle
                                          </label>
                                          <div class="col-sm-8">
                                            <input 
                                       ...
                                       <div  class="form-group{{ $errors->has('approved_term_id') ? ' has-error' : '' }}">
                                              
                                          <label for="approved_term_id" class="col-sm-4 control-label">
                                             Approved Repayment Cycle 
                                             <span class="text-danger"> *</span>
                                          </label>
                                          <div class="col-sm-8">
